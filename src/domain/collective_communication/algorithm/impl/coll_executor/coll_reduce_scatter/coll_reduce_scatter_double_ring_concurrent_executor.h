...
#ifndef COLL_REDUCESCATTER_DOUBLE_RING_CONCURRENT_EXECUTOR_H
#define COLL_REDUCESCATTER_DOUBLE_RING_CONCURRENT_EXECUTOR_H
#include "coll_reduce_scatter_executor.h"

namespace hccl {
class CollReduceScatterDoubleRingConcurrentExecutor : public CollReduceScatterExecutor {
public:
    explicit CollReduceScatterDoubleRingConcurrentExecutor(const HcclDispatcher dispatcher,
    std::unique_ptr<TopoMatcher> &topoMatcher);
    ~CollReduceScatterDoubleRingConcurrentExecutor() = default;
