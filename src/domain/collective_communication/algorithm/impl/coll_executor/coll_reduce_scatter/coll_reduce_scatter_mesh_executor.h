...
#ifndef COLL_REDUCESCATTER_MESH_EXECUTOR_H
#define COLL_REDUCESCATTER_MESH_EXECUTOR_H
#include "coll_reduce_scatter_executor.h"

namespace hccl {
class CollReduceScatterMeshExecutor : public CollReduceScatterExecutor {
public:
    explicit CollReduceScatterMeshExecutor(const HcclDispatcher dispatcher,
    std::unique_ptr<TopoMatcher> &topoMatcher);
    ~CollReduceScatterMeshExecutor() = default;
