...
#ifndef COLL_REDUCESCATTER_DETER_EXECUTOR_H
#define COLL_REDUCESCATTER_DETER_EXECUTOR_H
#include "coll_reduce_scatter_executor.h"

namespace hccl {
class CollReduceScatterDeterExecutor : public CollReduceScatterExecutor {
public:
    explicit CollReduceScatterDeterExecutor(const HcclDispatcher dispatcher,
    std::unique_ptr<TopoMatcher> &topoMatcher);
    ~CollReduceScatterDeterExecutor() = default;
