...
HcclResult CollAlignedAllReduceDoubleRingFor91093Executor::DoubleRingReduceScatter(const std::string &tag,
...
REGISTER_EXEC("AlignedAllReduceDoubleRingFor91093Executor", AlignedAllReduceDoubleRingFor91093,
